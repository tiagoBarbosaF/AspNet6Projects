...
using BlogDotnet5.ViewModels;
using BlogDotnet5.ViewModels.Posts;
...
public class PostController : ControllerBase
{
        ...
        [FromQuery] int pageSize = 10)
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<List<Post>>("05X03 - Não foi possível incluir a categoria."));
        }
    }
    ...
    public async Task<IActionResult> DetailsAsync([FromServices] BlogDataContext context, [FromRoute] int id)
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<Post>("05X03 - Não foi possível incluir a categoria."));
        }
    }
